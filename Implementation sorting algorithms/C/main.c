...
bool is_valid_option(char option) {
    ...
    result = (option == EXIT ||
              ...
              option == SELECTION_SORT || option == QUICK_SORT || option == BUBBLE_SORT || option == RAND_QUICK_SORT || option == 
              ODD_EVEN_SORT);
...
int main(int argc, char *argv[]) {
    ...
    do {
        ...
        case QUICK_SORT:
            ...
            break;
        case BUBBLE_SORT:
            ops = bubble_sort(array, length);
            break;
        case RAND_QUICK_SORT:
            ops = rand_quick_sort(array, length);
            break;
        case ODD_EVEN_SORT:
            ops = odd_even_sort(array, length);
            break;
        case EXIT:
            printf("Exiting.\n");
            return (EXIT_SUCCESS);
